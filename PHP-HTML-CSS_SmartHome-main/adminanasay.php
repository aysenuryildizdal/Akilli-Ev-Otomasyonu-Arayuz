...
<body class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li class="treeview"><a class="app-menu__item" href="adminanasay.php" data-toggle="treeview"><i
            class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Sayfalar</span><i
            class="treeview-indicator fa fa-angle-right"></i></a>
        <ul class="treeview-menu">

          <li><a class="treeview-item" href="adminanasay.php"><i class="icon fa fa-circle-o"></i> anasayfa</a></li>
              ...
              <tbody>
                ...
                while ($sonuc = $sorgu->fetch(PDO::FETCH_ASSOC)) {
                  ...
                  <tr>
                    ...
                    <td><?php echo $sonuc['linkmetın']; ?></td>
                    <td><?php echo $sonuc['link']; ?></td>
                    <td><?php echo $sonuc['hakkimizda']; ?></td>
                    <td><?php echo $sonuc['altlink']; ?></td>
                    <td><?php echo $sonuc['yorum']; ?></td>
                    <td class="text-center"><a href="anasayfagun.php?id=<?php echo $sonuc['ıd']; ?>">
