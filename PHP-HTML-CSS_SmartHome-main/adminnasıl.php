          ...
          <div class="tile-body">
            <table class="table table-hover table-bordered" id="">
              ...
              <tbody>
                ...
                ?>
                <tr>
                  <td><?php echo $sonuc['baslık']; ?></td>
                  <td><?php echo $sonuc['altbaslık']; ?></td>
                  <td><img src="images/<?php echo $sonuc['foto']; ?>" alt="" style="max-width: 50px;"></td>
                  <td><?php echo $sonuc['linkmetin']; ?></td>
                  <td><?php echo $sonuc['açıklama']; ?></td>
                  <td class="text-center"><a href="nasılgüncelle.php?id=<?php echo $sonuc['ıd']; ?>">
